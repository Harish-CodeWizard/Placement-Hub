...
export default function ApplicationMonitoring({ applications, setApplications }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-900 mb-4">Application Monitoring</h2>
          ...
          <tbody>
            {filteredApplications.map((app) => (
              <tr key={app.id} className="border-b border-gray-200">
                ...
                <td className="px-6 py-4 text-sm text-gray-700">{app.job.company.companyName}</td>
